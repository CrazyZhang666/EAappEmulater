...
public partial class AdvancedWindow
{
    ...
    private void IconButton_SelcetMainAppPath_Click(object sender, RoutedEventArgs e)
    {
    ...
    private void IconButton_SaveOption_Click(object sender, RoutedEventArgs e)
    {
    ...
    private void IconButton_CancelOption_Click(object sender, RoutedEventArgs e)
    {
        this.Close();
    }
