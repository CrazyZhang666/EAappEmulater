...
public static class Base
{
    ...
    static Base()
    {
        ...
        GameInfoDb[GameType.PVZGN] = new()
        {
            ...
            Slug = "pvz-battle-for-neighborville",
        ...
        GameInfoDb[GameType.BFLABS] = new()
        {
            ...
            Slug = "battlefield-labs", // 错误的, 等待修正
        ...
        GameInfoDb[GameType.BFVCA] = new()
        {
            ...
            Slug = "battlefield-v-closed-alpha", // 错误的, 等待修正
        ...
        GameInfoDb[GameType.BF1CA] = new()
        {
            ...
            Slug = "battlefield-1-closed-alpha", // 错误的, 等待修正
        ...
        GameInfoDb[GameType.BF4AT] = new()
        {
            ...
            Slug = "battlefield-4-alpha-trial", // 错误的, 等待修正
